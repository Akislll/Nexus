package com.nexus.backend.features.authentication.service;
...
import com.nexus.backend.features.authentication.dto.AuthenticationRequestBody;
import com.nexus.backend.features.authentication.dto.AuthenticationResponseBody;
import com.nexus.backend.features.authentication.model.User;
import com.nexus.backend.features.authentication.repository.UserRepository;
import com.nexus.backend.features.authentication.utils.EmailService;
import com.nexus.backend.features.authentication.utils.Encoder;
import com.nexus.backend.features.authentication.utils.JsonWebToken;
import com.nexus.backend.features.storage.service.StorageService;
...
public class AuthenticationService {
    ...
    public void sendEmailVerificationToken(String email) {
        ...
        if (user.isPresent() && !user.get().getEmailVerified()) {
            ...
            String body = String.format("Only one step to take full advantage of Nexus.\n\n"
    ...
    public AuthenticationResponseBody register(AuthenticationRequestBody registerRequestBody) {
        ...
        String body = String.format("""
                Only one step to take full advantage of Nexus.
