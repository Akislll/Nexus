  ...
  return (
    <div className={classes.root}>
      <div className={classes.sidebar}>
        <Title>Manage your Circle</Title>
        <div className={classes.buttons}>
          <NavLink to="signals" className={({ isActive }) => (isActive ? classes.active : "")}>
          ...
          <NavLink to="allies" className={({ isActive }) => (isActive ? classes.active : "")}>
            <svg
