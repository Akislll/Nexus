      ...
      <div className={classes.container}>
        <div className={classes.left}>
          <NavLink to="/" className={classes.brand}>
            <img src="/logo.svg" alt="Nexus logo" className={classes.logoMark} />
            <span className={classes.logoText}>Nexus</span>
          </NavLink>
          <Search />
        </div>
            ...
            <ul className={classes.navigation}>
              ...
              <li className={classes.network}>
                ...
                >
                  ...
                  <div>
                    {invitations.length > 0 && !location.pathname.includes("circle") ? (
              ...
              <li className={classes.messaging}>
                ...
                >
                  ...
                  <div>
                    {nonReadMessagesCount > 0 && !location.pathname.includes("threads") ? (
